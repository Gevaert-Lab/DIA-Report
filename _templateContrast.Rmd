...
if ( UP > 1 | DOWN > 1   ) {
   ...
   cat('Boxplot intensities of the top 10 DE proteins ordered by log2FC \n')
     ...
     contrast_values_paresed <- split_and_check_values(label, params$contrast, pe)
     log_info(contrast_values_paresed$Aleft$Group)
     log_info(contrast_values_paresed$Aleft$Timepoint)

     sample_sel <- select_samples(contrast_values_paresed, pe , params$contrast)
